...
contract DSCEngineTest is StdCheats, Test {
    ...
    function testGetUsdValue() public {
        ...
        uint256 expectedUsd = 30000e18; // on testnet fork, this will fail because the expected price ($2000) is hardcoded
    ...
    function testRevertsIfMintedDscBreaksHealthFactor() public {
        ...
        // amountToMint / AMOUNT_COLLATERAL = 1/1 collateral ratio
    ...
    function testCanMintWithDepositedCollateral() public depositedCollateralAndMintedDsc {
        uint256 userBalance = dsc.balanceOf(USER);
        // amountToMint / AMOUNT_COLLATERAL
        // --> $100 / 10 ETH
        // --> $100 / $20,000 (price feed returns $2000 / weth)
        // --> 200x overcollateralized
    ...
    modifier liquidated() {
        ...
        // - Reduce price below threshold
        MockV3Aggregator(ethUsdPriceFeed).updateAnswer(18e8); // 1 ETH = $18
        uint256 USERHealthFactor = dsce.getHealthFactor(USER);
