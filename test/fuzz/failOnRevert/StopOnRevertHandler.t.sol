...
// (e.g. always call approve before deposit) so that we don't waste fuzz runs
...
contract StopOnRevertHandler is Test {
    ...
    // This would break the test suite, because too sharp of a price decline would break the protocol
