...
contract DSCEngine is ReentrancyGuard {
    ...
    function mintDsc(uint256 amountDscToMint) public moreThanZero(amountDscToMint) nonReentrant {
        ...
        // if they minted too much, like $150 DSC for $100 ETH
        _revertIfHealthFactorIsBroken(msg.sender);
     ...
     * 1. $100 ETH backing $50 DSC
     * 2. $20 ETH backing $50 DSC --> DSC isn't worth $1 anymore
     * ---> if someone is undercollateralized, we will pay you to liquidate them.
     * 1. $75 ETH backing $50 DSC (close to undercollateralized)
     * 2. liquidator takes $75 ETH and pays debtor's $50 DSC, gets free $25!
     *
    ...
    /**
     * @dev Returns how close to liquidation the user is. If a user gose below 1, then they can get liquidated.
     * @notice borrowed from AAVE: https://docs.aave.com/risk/asset-risk/risk-parameters#health-factor
     */
     ...
     * allows for liquidator to remove user's DSC and give his DSC to the contract, effectively removing his tokens from circulation but not allowing the debtor to redeem his bad debt either
     */
    ...
    function getTokenAmountFromUsd(address token, uint256 usdAmountInWei) public view returns (uint256) {
        ...
        // Most USD pairs have 8 decimals, so we will just pretend they all do
        // ($100e18 * 1e18) / ($2000e8 * 1e10) = 0.05 ether
